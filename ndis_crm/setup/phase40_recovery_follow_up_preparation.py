...
def install():
    ...
    create_recovery_follow_up_preparation_doctypes()
    create_custom_fields_phase40()
    create_form_scripts()
    frappe.clear_cache()
    frappe.db.commit()
    print("NDIS CRM Phase 40 Recovery Follow Up Preparation bridge installed successfully.")
...
def ensure_required_doctypes():
    ...
    if missing:
        frappe.throw("Missing required Phase 40 DocTypes: " + ", ".join(missing))

    print("Required Phase 40 DocTypes found.")
...
def create_recovery_follow_up_preparation_doctypes():
    create_recovery_follow_up_preparation_line()
    create_recovery_follow_up_preparation_run()


def create_recovery_follow_up_preparation_line():
    fields = [
        make_field("Source", "source_section", "Section Break"),
        make_field("Recovery Follow Up Source Key", "recovery_follow_up_source_key", "Data", read_only=1),
        ...
        make_field("Follow Up Action Type", "follow_up_action_type", "Select", options="Accounts Recovery Follow-Up\nPlan Manager Follow-Up\nParticipant Debt Follow-Up\nProvider Correction Follow-Up\nNDIA / Portal Follow-Up\nDuplicate Payment Follow-Up\nOverpayment Follow-Up\nManual Follow-Up Review", in_list_view=1),
        make_field("Follow Up Priority", "follow_up_priority", "Select", options="High\nMedium\nNormal", default="Normal", in_list_view=1),
        ...
        make_field("Follow Up Channel", "follow_up_channel", "Select", options="Phone / Email Review\nPhone Call\nEmail\nInternal Review\nPortal Review", default="Phone / Email Review"),
        ...
        make_field("Recovery Follow Up Source Ready", "recovery_follow_up_source_ready", "Check", default="0"),
        make_field("Follow Up Review Complete", "follow_up_review_complete", "Check", default="0"),
        make_field("Contact Details Verified", "contact_details_verified", "Check", default="0"),
        make_field("Follow Up Decision Authorized", "follow_up_decision_authorized", "Check", default="0"),

        make_field("ToDo Creation Authorized", "todo_creation_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Task Creation Authorized", "task_creation_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Event Creation Authorized", "event_creation_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Email Creation Authorized", "email_creation_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Journal Entry Authorized", "journal_entry_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Manual GL Authorized", "manual_gl_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Payment Entry Authorized", "payment_entry_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Sales Invoice Authorized", "sales_invoice_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Adjustment Authorized", "adjustment_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Bank Reconciliation Authorized", "bank_reconciliation_authorized", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Recovery Follow Up Hold", "recovery_follow_up_hold", "Check", default="1", in_list_view=1),
        make_field("Recovery Follow Up Hold Reason", "recovery_follow_up_hold_reason", "Small Text"),

        make_field("Line Status", "line_status_section", "Section Break"),
        make_field("Line Ready for Recovery Follow Up Preparation", "line_ready_for_recovery_follow_up_preparation", "Check", default="0", in_list_view=1),
        make_field("Recovery Follow Up Preparation Line Status", "recovery_follow_up_preparation_line_status", "Select", options="Draft\nReady\nApproved\nFollow Up Prepared\nReturned\nCancelled", default="Draft", in_list_view=1),
        make_field("Notes", "notes", "Small Text"),
    ]

    create_doctype_if_missing(
        name=RECOVERY_FOLLOW_UP_PREPARATION_LINE,
        fields=fields,
        istable=1,
    )


def create_recovery_follow_up_preparation_run():
    fields = [
        make_field("Series", "naming_series", "Select", options="NDIS-RECOVERY-FOLLOWUP-PREP-.YYYY.-.#####", default="NDIS-RECOVERY-FOLLOWUP-PREP-.YYYY.-.#####", reqd=1),

        make_field("Status", "status_section", "Section Break"),
        make_field("Status", "status", "Select", options="Draft\nIn Review\nReady for Recovery Follow Up Preparation\nRecovery Follow Up Preparation Approved\nRecovery Follow Up Prepared\nReturned to Recovery Case Submission\nCancelled", default="Draft", in_list_view=1),
        make_field("Readiness %", "readiness_percent", "Percent", read_only=1, in_list_view=1),
        make_field("Recovery Follow Up Preparation Run Ready", "recovery_follow_up_preparation_run_ready", "Check", read_only=1, in_list_view=1),
        make_field("No Recovery Follow Up Candidate Found", "no_recovery_follow_up_candidate_found", "Check", default="0", read_only=1),
        make_field("Recovery Follow Up Preparation Completion Allowed", "recovery_follow_up_preparation_completion_allowed", "Check", default="0"),

        make_field("ToDo Creation Allowed", "todo_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Task Creation Allowed", "task_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Event Creation Allowed", "event_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Email Creation Allowed", "email_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Journal Entry Creation Allowed", "journal_entry_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Manual GL Creation Allowed", "manual_gl_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Payment Entry Creation Allowed", "payment_entry_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Sales Invoice Creation Allowed", "sales_invoice_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Adjustment Creation Allowed", "adjustment_creation_allowed", "Check", default="0", description="Blocked in Phase 40."),
        make_field("Bank Reconciliation Allowed", "bank_reconciliation_allowed", "Check", default="0", description="Blocked in Phase 40."),

        make_field("Summary", "summary_section", "Section Break"),
        make_field("Recovery Follow Up Preparation Line Count", "recovery_follow_up_preparation_line_count", "Int", read_only=1),
        make_field("Recovery Follow Up Amount Total", "recovery_follow_up_amount_total", "Currency", read_only=1),
        make_field("Recovery Follow Up Ready Count", "recovery_follow_up_ready_count", "Int", read_only=1),
        make_field("Recovery Follow Up Hold Count", "recovery_follow_up_hold_count", "Int", read_only=1),
        make_field("High Priority Follow Up Count", "high_priority_follow_up_count", "Int", read_only=1),
        make_field("Medium Priority Follow Up Count", "medium_priority_follow_up_count", "Int", read_only=1),
        make_field("Normal Priority Follow Up Count", "normal_priority_follow_up_count", "Int", read_only=1),
        make_field("Follow Up Prepared Line Count", "follow_up_prepared_line_count", "Int", read_only=1),
    ...
    fields += [
        ...
        make_field("NDIS CRM Recovery Case Submission Run", "recovery_case_submission_run", "Link", options=RECOVERY_CASE_SUBMISSION_RUN, reqd=1, in_list_view=1),
    ...
    fields += [
        ...
        make_field("Recovery Follow Up Preparation Owner", "recovery_follow_up_preparation_owner", "Link", options="User", in_list_view=1),
        make_field("Recovery Case Submission Owner", "recovery_case_submission_owner", "Link", options="User"),
        ...
        make_field("Recovery Follow Up Preparation Lines", "recovery_follow_up_preparation_lines_section", "Section Break"),
        make_field("Recovery Follow Up Preparation Lines", "recovery_follow_up_preparation_lines", "Table", options=RECOVERY_FOLLOW_UP_PREPARATION_LINE),

        make_field("Notes", "notes_section", "Section Break"),
        make_field("Recovery Follow Up Preparation Notes", "recovery_follow_up_preparation_notes", "Small Text"),
        make_field("Returned / Blocker Notes", "returned_notes", "Small Text"),
    ]

    create_doctype_if_missing(
        name=RECOVERY_FOLLOW_UP_PREPARATION_RUN,
        fields=fields,
...
def create_custom_fields_phase40():
    # CRM Deal uses Small Text for run/status fields to avoid MariaDB row-size pressure.
    deal_fields = [
        {
            "fieldname": "recovery_follow_up_preparation_section",
            "label": "NDIS Recovery Follow Up Preparation Run",
            "fieldtype": "Section Break",
            "insert_after": "recovery_case_submission_ready",
        },
        {
            "fieldname": "ndis_recovery_follow_up_preparation_run_required",
            "label": "Recovery Follow Up Preparation Required Before Active Deal",
            "fieldtype": "Check",
            "default": "0",
            "insert_after": "recovery_follow_up_preparation_section",
            "description": "Optional guard only. Follow-up preparation normally happens after recovery case submission.",
        },
        {
            "fieldname": "ndis_recovery_follow_up_preparation_run",
            "label": "NDIS CRM Recovery Follow Up Preparation Run",
            "fieldtype": "Small Text",
            "read_only": 1,
            "insert_after": "ndis_recovery_follow_up_preparation_run_required",
        },
        {
            "fieldname": "recovery_follow_up_preparation_status",
            "label": "Recovery Follow Up Preparation Status",
            "fieldtype": "Small Text",
            "read_only": 1,
            "insert_after": "ndis_recovery_follow_up_preparation_run",
        },
        {
            "fieldname": "recovery_follow_up_preparation_ready",
            "label": "Recovery Follow Up Preparation Ready",
            "fieldtype": "Check",
            "read_only": 1,
            "insert_after": "recovery_follow_up_preparation_status",
        },
    ]
    ...
    shared_fields = [
        ...
        },
        {
            ...
            "label": "NDIS CRM Recovery Follow Up Preparation Run",
            "fieldtype": "Link",
            "options": RECOVERY_FOLLOW_UP_PREPARATION_RUN,
            "read_only": 1,
            "insert_after": "recovery_follow_up_preparation_section",
        },
        {
    ...
    repair_partial_crm_deal_phase40_fields()
    create_custom_fields(custom_fields, update=True)
    print("Created / updated Phase 40 recovery follow-up preparation chain custom fields.")


def repair_partial_crm_deal_phase40_fields():
    for fieldname in [
...
def _phase40_deal_actions():
    return r'''
// NDIS CRM Phase 40 Deal Actions
{
  label: "Create Recovery Follow Up Preparation Run",
  onClick: () => {
    call("ndis_crm.phase40_recovery_follow_up_preparation.create_recovery_follow_up_preparation_run_from_crm_deal", {
      deal: doc.name
    }).then((data) => {
      if (data && data.name) {
        createToast({
          title: data.created ? "Recovery Follow Up Preparation Run Created" : "Existing Recovery Follow Up Preparation Run Found",
          icon: "check",
          iconClasses: "text-green-600",
        })
        window.open(`/app/ndis-crm-recovery-follow-up-preparation-run/${data.name}`, "_blank")
      }
    })
  }
},
{
  label: "Open Recovery Follow Up Preparation Run",
  onClick: () => {
    if (doc.ndis_recovery_follow_up_preparation_run) {
      window.open(`/app/ndis-crm-recovery-follow-up-preparation-run/${doc.ndis_recovery_follow_up_preparation_run}`, "_blank")
    } else {
      createToast({ title: "No Recovery Follow Up Preparation Run linked yet", icon: "info" })
    }
  }
}
'''.strip()
...
def _deal_script():
    try:
        from ndis_crm.setup.phase39_recovery_case_submission import _deal_script as phase39_deal_script
        script = phase39_deal_script()
    except Exception:
        script = '''
...
'''.strip()
    ...
    if "NDIS CRM Phase 40 Deal Actions" in script:
        return script

    return _append_before_last(script, "\n    ]", _phase40_deal_actions())
...
frappe.ui.form.on("NDIS CRM Recovery Case Submission Run", {
    refresh(frm) {
        ...
        frm.add_custom_button(__("Create Recovery Follow Up Preparation Run"), function () {
            frappe.call({
                method: "ndis_crm.phase40_recovery_follow_up_preparation.create_recovery_follow_up_preparation_run_from_case_submission_run",
                args: { recovery_case_submission_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Creating recovery follow-up preparation run...")
            }).then((r) => {
                if (r.message && r.message.name) {
                    frappe.show_alert({ message: r.message.message || __("Recovery Follow Up Preparation Run created"), indicator: "green" });
                    frm.reload_doc();
                    frappe.set_route("Form", "NDIS CRM Recovery Follow Up Preparation Run", r.message.name);
                }
            });
        }, __("Actions"));

        if (frm.doc.ndis_recovery_follow_up_preparation_run) {
            frm.add_custom_button(__("Open Recovery Follow Up Preparation Run"), function () {
                frappe.set_route("Form", "NDIS CRM Recovery Follow Up Preparation Run", frm.doc.ndis_recovery_follow_up_preparation_run);
            }, __("Open"));
        }
    }
});
...
frappe.ui.form.on("NDIS CRM Recovery Follow Up Preparation Run", {
    refresh(frm) {
        ...
        frm.add_custom_button(__("Generate Follow Up Lines"), function () {
            frappe.call({
                method: "ndis_crm.phase40_recovery_follow_up_preparation.generate_recovery_follow_up_preparation_lines",
                args: { recovery_follow_up_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Generating recovery follow-up preparation lines...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Recovery follow-up lines generated"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Validate Follow Up Readiness"), function () {
            frappe.call({
                method: "ndis_crm.phase40_recovery_follow_up_preparation.validate_recovery_follow_up_preparation_readiness",
                args: { recovery_follow_up_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Validating recovery follow-up readiness...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Recovery follow-up readiness validated"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Mark Ready for Follow Up Preparation"), function () {
            frappe.call({
                method: "ndis_crm.phase40_recovery_follow_up_preparation.mark_ready_for_recovery_follow_up_preparation",
                args: { recovery_follow_up_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Marking ready for recovery follow-up preparation...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Ready for recovery follow-up preparation"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Approve Follow Up Preparation Run"), function () {
            frappe.call({
                method: "ndis_crm.phase40_recovery_follow_up_preparation.approve_recovery_follow_up_preparation_run",
                args: { recovery_follow_up_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Approving recovery follow-up preparation run...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Recovery Follow Up Preparation Run approved"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Complete Follow Up Preparation"), function () {
            frappe.confirm(
                __("This prepares follow-up actions only. It will not create ToDo, Task, Event, Email, Journal Entry, GL Entry, Payment Entry, Sales Invoice, adjustment, bank reconciliation, Claim Batch, Claim Line, or Remittance Import."),
                function () {
                    frappe.call({
                        method: "ndis_crm.phase40_recovery_follow_up_preparation.complete_recovery_follow_up_preparation",
                        args: { recovery_follow_up_preparation_run: frm.doc.name },
                        freeze: true,
                        freeze_message: __("Completing recovery follow-up preparation...")
                    }).then((r) => {
                        if (r.message) {
                            frappe.show_alert({ message: r.message.message || __("Recovery follow-up preparation completed"), indicator: "green" });
                            frm.reload_doc();
                        }
                    });
                }
        ...
        if (frm.doc.recovery_case_submission_run) {
            frm.add_custom_button(__("Open Recovery Case Submission Run"), function () {
                frappe.set_route("Form", "NDIS CRM Recovery Case Submission Run", frm.doc.recovery_case_submission_run);
            }, __("Open"));
        }
