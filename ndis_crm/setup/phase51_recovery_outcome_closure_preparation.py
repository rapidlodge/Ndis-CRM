...
def install():
    ...
    create_recovery_outcome_closure_preparation_doctypes()
    create_custom_fields_phase51()
    create_form_scripts()
    frappe.clear_cache()
    frappe.db.commit()
    print("NDIS CRM Phase 51 Recovery Outcome Closure Preparation bridge installed successfully.")
...
def repair_partial_crm_deal_phase51_fields():
    expected = {
    ...
    for fieldname, values in expected.items():
        ...
        if changed:
            ...
            print(f"Repaired CRM Deal Phase 51 field: {custom_field_name}")
...
def ensure_required_doctypes():
    ...
    if missing:
        frappe.throw("Missing required Phase 51 DocTypes: " + ", ".join(missing))

    print("Required Phase 51 DocTypes found.")
...
def create_recovery_outcome_closure_preparation_doctypes():
    create_recovery_outcome_closure_preparation_line()
    create_recovery_outcome_closure_preparation_run()


def create_recovery_outcome_closure_preparation_line():
    fields = [
        make_field("Source", "source_section", "Section Break"),
        make_field("Recovery Outcome Closure Preparation Source Key", "recovery_outcome_closure_preparation_source_key", "Data", read_only=1),

        make_field("Completed Action Snapshot", "completed_action_section", "Section Break"),
        ...
        make_field("Existing References", "existing_refs_section", "Section Break"),
        ...
        make_field("Closure Preparation", "closure_preparation_section", "Section Break"),
        make_field("Recovery Outcome Closure Source Ready", "recovery_outcome_closure_source_ready", "Check", default="0"),
        make_field("Action Type", "action_type", "Data", in_list_view=1),
        make_field("Action Route", "action_route", "Data"),
        make_field("Action Owner", "action_owner", "Link", options="User"),
        make_field("Action Completion Summary", "action_completion_summary", "Small Text"),
        make_field("Action Completion Reference", "action_completion_reference", "Data"),

        make_field("Closure Decision", "closure_decision", "Select", options="Prepare Recovery Closure\nPrepare Repeat Follow-Up\nPrepare Payment Promise Monitoring Continuation\nPrepare Evidence Follow-Up\nPrepare Dispute Review\nPrepare Contact Correction Review\nPrepare Escalation Review\nPrepare Manual Review", in_list_view=1),
        ...
        make_field("Closure Due Date", "closure_due_date", "Date", in_list_view=1),
        ...
        make_field("Closure Review Complete", "closure_review_complete", "Check", default="0"),
        make_field("Closure Decision Recorded", "closure_decision_recorded", "Check", default="0"),
        make_field("Closure Authorized", "closure_authorized", "Check", default="0"),

        make_field("Blocked Downstream Controls", "blocked_downstream_section", "Section Break"),
        make_field("Communication Creation Authorized", "communication_creation_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Email Send Authorized", "email_send_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Event Creation Authorized", "event_creation_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("ToDo Creation Authorized", "todo_creation_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Task Creation Authorized", "task_creation_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Recovery Case Creation Authorized", "recovery_case_creation_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Recovery Case Closure Authorized", "recovery_case_closure_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Journal Entry Authorized", "journal_entry_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Manual GL Authorized", "manual_gl_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Payment Entry Authorized", "payment_entry_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Sales Invoice Authorized", "sales_invoice_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Adjustment Authorized", "adjustment_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Bank Reconciliation Authorized", "bank_reconciliation_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Claim Batch Authorized", "claim_batch_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Claim Line Authorized", "claim_line_authorized", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Remittance Import Authorized", "remittance_import_authorized", "Check", default="0", description="Blocked in Phase 51."),

        make_field("Line Status", "line_status_section", "Section Break"),
        make_field("Recovery Outcome Closure Preparation Hold", "recovery_outcome_closure_preparation_hold", "Check", default="1", in_list_view=1),
        make_field("Recovery Outcome Closure Preparation Hold Reason", "recovery_outcome_closure_preparation_hold_reason", "Small Text"),
        make_field("Line Ready for Recovery Outcome Closure Preparation", "line_ready_for_recovery_outcome_closure_preparation", "Check", default="0", in_list_view=1),
        make_field("Recovery Outcome Closure Preparation Line Status", "recovery_outcome_closure_preparation_line_status", "Select", options="Draft\nReady\nApproved\nClosure Decision Prepared\nReturned\nCancelled", default="Draft", in_list_view=1),
        make_field("Notes", "notes", "Small Text"),
    ]

    create_doctype_if_missing(
        name=RECOVERY_OUTCOME_CLOSURE_PREPARATION_LINE,
        fields=fields,
        istable=1,
    )


def create_recovery_outcome_closure_preparation_run():
    fields = [
        make_field("Series", "naming_series", "Select", options="NDIS-RECOVERY-CLOSURE-PREP-.YYYY.-.#####", default="NDIS-RECOVERY-CLOSURE-PREP-.YYYY.-.#####", reqd=1),

        make_field("Status", "status_section", "Section Break"),
        make_field("Status", "status", "Select", options="Draft\nIn Review\nReady for Closure Preparation\nClosure Preparation Approved\nClosure Prepared\nReturned to Action Completion\nCancelled", default="Draft", in_list_view=1),
        make_field("Readiness %", "readiness_percent", "Percent", read_only=1, in_list_view=1),
        make_field("Recovery Outcome Closure Preparation Run Ready", "recovery_outcome_closure_preparation_run_ready", "Check", read_only=1, in_list_view=1),
        make_field("No Recovery Outcome Closure Preparation Candidate Found", "no_recovery_outcome_closure_preparation_candidate_found", "Check", default="0", read_only=1),

        make_field("Closure Preparation Completion Allowed", "closure_preparation_completion_allowed", "Check", default="0"),
        make_field("Communication Creation Allowed", "communication_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Email Send Allowed", "email_send_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Event Creation Allowed", "event_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("ToDo Creation Allowed", "todo_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Task Creation Allowed", "task_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Recovery Case Creation Allowed", "recovery_case_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Recovery Case Closure Allowed", "recovery_case_closure_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Journal Entry Creation Allowed", "journal_entry_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Manual GL Creation Allowed", "manual_gl_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Payment Entry Creation Allowed", "payment_entry_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Sales Invoice Creation Allowed", "sales_invoice_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Adjustment Creation Allowed", "adjustment_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Bank Reconciliation Allowed", "bank_reconciliation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Claim Batch Creation Allowed", "claim_batch_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Claim Line Creation Allowed", "claim_line_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),
        make_field("Remittance Import Creation Allowed", "remittance_import_creation_allowed", "Check", default="0", description="Blocked in Phase 51."),

        make_field("Summary", "summary_section", "Section Break"),
        make_field("Recovery Outcome Closure Preparation Line Count", "recovery_outcome_closure_preparation_line_count", "Int", read_only=1),
        make_field("Recovery Outcome Closure Amount Total", "recovery_outcome_closure_amount_total", "Currency", read_only=1),
        make_field("Recovery Outcome Closure Ready Count", "recovery_outcome_closure_ready_count", "Int", read_only=1),
        make_field("Recovery Outcome Closure Hold Count", "recovery_outcome_closure_hold_count", "Int", read_only=1),
        make_field("Prepare Recovery Closure Count", "prepare_recovery_closure_count", "Int", read_only=1),
        make_field("Prepare Repeat Follow Up Count", "prepare_repeat_follow_up_count", "Int", read_only=1),
        make_field("Prepare Payment Promise Monitoring Count", "prepare_payment_promise_monitoring_count", "Int", read_only=1),
        make_field("Prepare Evidence Follow Up Count", "prepare_evidence_follow_up_count", "Int", read_only=1),
        make_field("Prepare Dispute Review Count", "prepare_dispute_review_count", "Int", read_only=1),
        make_field("Prepare Contact Correction Count", "prepare_contact_correction_count", "Int", read_only=1),
        make_field("Prepare Escalation Review Count", "prepare_escalation_review_count", "Int", read_only=1),
        make_field("Prepare Manual Review Count", "prepare_manual_review_count", "Int", read_only=1),
        make_field("Closure Decision Prepared Count", "closure_decision_prepared_count", "Int", read_only=1),
        ...
        make_field("Blocked Recovery Case Closure Count", "blocked_recovery_case_closure_count", "Int", read_only=1),
    ...
    fields += [
        ...
        make_field("NDIS CRM Recovery Outcome Action Completion Run", "recovery_outcome_action_completion_run", "Link", options=RECOVERY_OUTCOME_ACTION_COMPLETION_RUN, reqd=1, in_list_view=1),
        ...
        make_field("Recovery Outcome Closure Preparation Owner", "recovery_outcome_closure_preparation_owner", "Link", options="User", in_list_view=1),
        make_field("Recovery Outcome Action Completion Owner", "recovery_outcome_action_completion_owner", "Link", options="User"),
        ...
        make_field("Recovery Outcome Closure Preparation Lines", "recovery_outcome_closure_preparation_lines_section", "Section Break"),
        make_field("Recovery Outcome Closure Preparation Lines", "recovery_outcome_closure_preparation_lines", "Table", options=RECOVERY_OUTCOME_CLOSURE_PREPARATION_LINE),

        make_field("Notes", "notes_section", "Section Break"),
        make_field("Recovery Outcome Closure Preparation Notes", "recovery_outcome_closure_preparation_notes", "Small Text"),
        make_field("Returned / Blocker Notes", "returned_notes", "Small Text"),
    ]

    create_doctype_if_missing(
        name=RECOVERY_OUTCOME_CLOSURE_PREPARATION_RUN,
        fields=fields,
...
def create_custom_fields_phase51():
    deal_fields = [
        {
            "fieldname": "recovery_outcome_closure_preparation_section",
            "label": "NDIS Recovery Outcome Closure Preparation Run",
            "fieldtype": "Section Break",
            "insert_after": "recovery_outcome_action_completion_ready",
        },
        {
            "fieldname": "ndis_recovery_outcome_closure_preparation_run_required",
            "label": "Recovery Outcome Closure Preparation Required Before Active Deal",
            "fieldtype": "Check",
            "default": "0",
            "insert_after": "recovery_outcome_closure_preparation_section",
        },
        {
            "fieldname": "ndis_recovery_outcome_closure_preparation_run",
            "label": "NDIS CRM Recovery Outcome Closure Preparation Run",
            "fieldtype": "Small Text",
            "read_only": 1,
            "insert_after": "ndis_recovery_outcome_closure_preparation_run_required",
        },
        {
            "fieldname": "recovery_outcome_closure_preparation_status",
            "label": "Recovery Outcome Closure Preparation Status",
            "fieldtype": "Small Text",
            "read_only": 1,
            "insert_after": "ndis_recovery_outcome_closure_preparation_run",
        },
        {
            "fieldname": "recovery_outcome_closure_preparation_ready",
            "label": "Recovery Outcome Closure Preparation Ready",
            "fieldtype": "Check",
            "read_only": 1,
            "insert_after": "recovery_outcome_closure_preparation_status",
        },
    ]
    ...
    shared_fields = [
        ...
        },
        {
            ...
            "label": "NDIS CRM Recovery Outcome Closure Preparation Run",
            "fieldtype": "Link",
            "options": RECOVERY_OUTCOME_CLOSURE_PREPARATION_RUN,
            "read_only": 1,
            "insert_after": "recovery_outcome_closure_preparation_section",
        },
        {
    ...
    custom_fields = {
        ...
        RECOVERY_OUTCOME_ACTION_COMPLETION_RUN: shared_fields,
    ...
    repair_partial_crm_deal_phase51_fields()
    safe_create_custom_fields(custom_fields)
    print("Created / updated Phase 51 recovery outcome closure preparation chain custom fields.")
...
def _phase51_deal_actions():
    return r'''
// NDIS CRM Phase 51 Deal Actions
{
  label: "Create Recovery Outcome Closure Preparation Run",
  onClick: () => {
    call("ndis_crm.phase51_recovery_outcome_closure_preparation.create_recovery_outcome_closure_preparation_run_from_crm_deal", {
      deal: doc.name
    }).then((data) => {
      if (data && data.name) {
        createToast({
          title: data.created ? "Recovery Outcome Closure Preparation Run Created" : "Existing Recovery Outcome Closure Preparation Run Found",
          icon: "check",
          iconClasses: "text-green-600",
        })
        window.open(`/app/ndis-crm-recovery-outcome-closure-preparation-run/${data.name}`, "_blank")
      }
    })
  }
},
{
  label: "Open Recovery Outcome Closure Preparation Run",
  onClick: () => {
    if (doc.ndis_recovery_outcome_closure_preparation_run) {
      window.open(`/app/ndis-crm-recovery-outcome-closure-preparation-run/${doc.ndis_recovery_outcome_closure_preparation_run}`, "_blank")
    } else {
      createToast({ title: "No Recovery Outcome Closure Preparation Run linked yet", icon: "info" })
    }
  }
}
'''.strip()
...
def _deal_script():
    try:
        from ndis_crm.setup.phase50_recovery_outcome_action_completion import _deal_script as phase50_deal_script

        script = phase50_deal_script()
    except Exception:
        script = '''
...
'''.strip()
    ...
    if "NDIS CRM Phase 51 Deal Actions" in script:
        return script

    return _append_before_last(script, "\n    ]", _phase51_deal_actions())
...
frappe.ui.form.on("NDIS CRM Recovery Outcome Action Completion Run", {
    refresh(frm) {
        ...
        frm.add_custom_button(__("Create Recovery Outcome Closure Preparation Run"), function () {
            frappe.call({
                method: "ndis_crm.phase51_recovery_outcome_closure_preparation.create_recovery_outcome_closure_preparation_run_from_action_completion_run",
                args: { recovery_outcome_action_completion_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Creating recovery outcome closure preparation run...")
            }).then((r) => {
                if (r.message && r.message.name) {
                    frappe.show_alert({ message: r.message.message || __("Recovery Outcome Closure Preparation Run created"), indicator: "green" });
                    frm.reload_doc();
                    frappe.set_route("Form", "NDIS CRM Recovery Outcome Closure Preparation Run", r.message.name);
                }
            });
        }, __("Actions"));

        if (frm.doc.ndis_recovery_outcome_closure_preparation_run) {
            frm.add_custom_button(__("Open Recovery Outcome Closure Preparation Run"), function () {
                frappe.set_route("Form", "NDIS CRM Recovery Outcome Closure Preparation Run", frm.doc.ndis_recovery_outcome_closure_preparation_run);
            }, __("Open"));
        }
    }
});
'''.strip()
    ...
    run_script = r'''
frappe.ui.form.on("NDIS CRM Recovery Outcome Closure Preparation Run", {
    refresh(frm) {
        if (frm.is_new()) {
            return;
        }

        frm.add_custom_button(__("Generate Closure Lines"), function () {
            frappe.call({
                method: "ndis_crm.phase51_recovery_outcome_closure_preparation.generate_recovery_outcome_closure_preparation_lines",
                args: { recovery_outcome_closure_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Generating closure preparation lines...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Closure preparation lines generated"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Validate Closure Readiness"), function () {
            frappe.call({
                method: "ndis_crm.phase51_recovery_outcome_closure_preparation.validate_recovery_outcome_closure_preparation_readiness",
                args: { recovery_outcome_closure_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Validating closure readiness...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Closure readiness validated"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Mark Ready for Closure Preparation"), function () {
            frappe.call({
                method: "ndis_crm.phase51_recovery_outcome_closure_preparation.mark_ready_for_recovery_outcome_closure_preparation",
                args: { recovery_outcome_closure_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Marking ready for closure preparation...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Ready for closure preparation"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Approve Closure Preparation Run"), function () {
            frappe.call({
                method: "ndis_crm.phase51_recovery_outcome_closure_preparation.approve_recovery_outcome_closure_preparation_run",
                args: { recovery_outcome_closure_preparation_run: frm.doc.name },
                freeze: true,
                freeze_message: __("Approving closure preparation run...")
            }).then((r) => {
                if (r.message) {
                    frappe.show_alert({ message: r.message.message || __("Closure Preparation Run approved"), indicator: "green" });
                    frm.reload_doc();
                }
            });
        }, __("Actions"));

        frm.add_custom_button(__("Complete Closure Preparation"), function () {
            frappe.confirm(
                __("This prepares closure / next-step decisions only. It will not close recovery cases, create communications, tasks, emails, accounting, claim, remittance, adjustment, or bank reconciliation records."),
                function () {
                    frappe.call({
                        method: "ndis_crm.phase51_recovery_outcome_closure_preparation.complete_recovery_outcome_closure_preparation",
                        args: { recovery_outcome_closure_preparation_run: frm.doc.name },
                        freeze: true,
                        freeze_message: __("Completing closure preparation...")
                    }).then((r) => {
                        if (r.message) {
                            frappe.show_alert({ message: r.message.message || __("Closure preparation completed"), indicator: "green" });
                            frm.reload_doc();
                        }
                    });
                }
        ...
        if (frm.doc.recovery_outcome_action_completion_run) {
            frm.add_custom_button(__("Open Action Completion Run"), function () {
                frappe.set_route("Form", "NDIS CRM Recovery Outcome Action Completion Run", frm.doc.recovery_outcome_action_completion_run);
            }, __("Open"));
        }
...
'''.strip()
    ...
    if frappe.db.exists("DocType", "Client Script"):
        ...
        upsert_doc(
            ...
            {
                "dt": RECOVERY_OUTCOME_CLOSURE_PREPARATION_RUN,
                "view": "Form",
                "enabled": 1,
                "script": run_script,
            },
